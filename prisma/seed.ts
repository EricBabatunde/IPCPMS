...
async function main() {
  ...
  const taskDefinitions: Array<{
    ...
    { title: "Communication Protocol Testing", description: "Test Modbus TCP/IP and Profinet communication between PLCs, drives, and SCADA servers.", status: TaskStatus.IN_PROGRESS, priority: TaskPriority.MEDIUM, projectId: project1.id, assigneeIds: [bob.id], creatorId: alice.id, dueDate: addDays(new Date(), 10), position: 0 },
